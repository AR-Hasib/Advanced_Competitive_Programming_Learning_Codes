...
int main() {
    ...
    // Query XOR from index 1 to 3 (0-based)
    Node1 result = seg.make_query(1, 3);
    cout << "XOR from index 1 to 3: " << result.val << '\n';  // 3 ^ 5 ^ 7 = 5

    // Update index 2 to value 4
    seg.make_update(2, 4);  // changes 5 → 4

    // Query again after update
    result = seg.make_query(1, 3);
    cout << "After update, XOR from index 1 to 3: " << result.val << '\n';  // 3 ^ 4 ^ 7 = 0
